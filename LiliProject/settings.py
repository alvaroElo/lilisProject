"""
Django settings for LiliProject project.
...
ALLOWED_HOSTS = ['*']  # En producción, especificar dominios específicos
...
MIDDLEWARE = [
    ...
    'autenticacion.middleware.RoleBasedAdminMiddleware',  # Middleware personalizado para roles
...
if USE_S3:
    # AWS S3 Settings (Producción)
    AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY')
    AWS_STORAGE_BUCKET_NAME = os.getenv('AWS_STORAGE_BUCKET_NAME', 'dulceria-lilis-media')
